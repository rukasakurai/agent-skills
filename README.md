...
| [`microsoft-product-updates`](skills/microsoft-product-updates/SKILL.md) | Fetch and interpret recent Microsoft product updates (Azure and GitHub) from their authoritative change feeds, reading lifecycle signals (GA, preview, retirement) consistently to spot what recently changed for a product. |
